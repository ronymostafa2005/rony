      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            <motion.h3
              ...
              className="text-2xl font-bold bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent mb-4 inline-block"
            >
              RAWAN.DEV
            </motion.h3>
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="w-9 h-9 rounded-lg bg-slate-800/60 border border-slate-700/50 flex items-center justify-center text-gray-400 hover:text-white hover:border-blue-500/40 hover:bg-blue-500/10 transition-all duration-300"
                >
                  <social.icon size={15} />
                </motion.a>
              ))}
        ...
        <div className="border-t border-slate-800/50 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="text-gray-500 hover:text-blue-400 transition-colors duration-300 flex items-center gap-2 text-sm"
          >
            Back to top
