      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        <div className="relative" ref={timelineRef}>
          ...
          <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-[2px] h-full">
            ...
            <motion.div
              className="absolute top-0 left-0 w-full bg-gradient-to-b from-teal-400 via-emerald-500 to-cyan-400"
            ...
            >
              <div className={`${index % 2 === 0 ? 'md:pr-12' : 'md:pl-12'}`}>
                <motion.div
                  ...
                  className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 md:p-7 border border-slate-700/40 hover:border-teal-500/30 transition-all duration-500 relative group"
                  style={{
                ...
                >
                  ...
                  {/* Header */}
                  <div className="mb-4">
                    <h3 className="text-xl md:text-2xl font-bold text-white mb-1 group-hover:text-teal-300 transition-colors duration-300">
                      {exp.company}
                    </h3>
                  ...
                  <div className="flex flex-wrap gap-4 mb-4">
                    <div className="flex items-center text-gray-400 text-sm">
                      <span className="mr-2 inline-flex"><Icon3D name="Tear-off calendar" size={14} /></span>
                      <span>{exp.period}</span>
                    </div>
                    <div className="flex items-center text-gray-400 text-sm">
                      <span className="mr-2 inline-flex"><Icon3D name="Pushpin" size={14} /></span>
                  ...
                  <ul className="space-y-2 mb-5">
                    {exp.description.map((item, i) => (
                      ...
                      >
                        <span className="text-teal-300 mt-1.5 text-[6px]">●</span>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {exp.tags.map((tag, i) => (
                      <span
                        key={i}
                        className="px-3 py-1 text-xs bg-slate-700/40 text-teal-300 rounded-full border border-slate-600/40 hover:border-teal-500/40 transition-colors duration-300"
                      >
                        {tag}
                      </span>
                    ))}
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <motion.div
              whileHover={{ scale: 1.03, y: -5 }}
              className="bg-slate-800/40 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/40 hover:border-teal-500/30 transition-all duration-300 group"
            >
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-teal-500/20 to-emerald-500/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                <Icon3D name="Laptop" size={24} />
              </div>
              <h4 className="text-xl font-bold text-white mb-2">Black Hours Academy</h4>
              <p className="text-teal-300 font-semibold mb-2">Front-End Developer Course</p>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-teal-400 to-emerald-500 rounded-full text-white font-semibold shadow-lg relative overflow-hidden"
            style={{ boxShadow: '0 4px 25px rgba(20, 184, 166, 0.3)' }}
          >
            <span className="relative z-10 flex items-center gap-2">
              <Icon3D name="Page facing up" size={20} />
